...
def test_anthropic_client_calls_sdk_correctly(monkeypatch):
    ...
    monkeypatch.setattr("anthropic.Anthropic", lambda api_key, base_url=None, timeout=None, **kwargs: fake_instance)
...
def test_openai_llm_client_calls_sdk_correctly(monkeypatch):
    ...
    monkeypatch.setattr("openai.OpenAI", lambda api_key, base_url=None, timeout=None, **kwargs: fake_instance)
